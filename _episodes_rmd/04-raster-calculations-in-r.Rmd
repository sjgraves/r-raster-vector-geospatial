...
If you are starting this lesson from the beginning, you will need to create dataframes from each of these four rasters using `as.data.frame()` and specifying the argument `xy=TRUE`.
...
* using the `overlay()` function from the `raster` package.
