...
~~~
Error: Cannot open "data/NEON-DS-Site-Layout-Files/US-Boundary-Layers/US-Boundary-Dissolved-States.shp"; The file doesn't seem to exist.
~~~
{: .error}
...
~~~
Error in str(plot_locations_HARV): object 'plot_locations_HARV' not found
~~~
{: .error}
...
~~~
Error in eval(expr, envir, enclos): object 'plot_locations_HARV' not found
~~~
{: .error}
...
~~~
Error in head(plot_locations_HARV$easting): object 'plot_locations_HARV' not found
~~~
{: .error}
...
~~~
Error in head(plot_locations_HARV$northing): object 'plot_locations_HARV' not found
~~~
{: .error}
...
~~~
Error in head(plot_locations_HARV$geodeticDa): object 'plot_locations_HARV' not found
~~~
{: .error}
...
~~~
Error in head(plot_locations_HARV$utmZone): object 'plot_locations_HARV' not found
~~~
{: .error}
...
~~~
Error in st_crs(plot_locations_sp_HARV): object 'plot_locations_sp_HARV' not found
~~~
{: .error}
...
> > 
> > ~~~
> > Error in str(newplot_locations_HARV): object 'newplot_locations_HARV' not found
> > ~~~
> > {: .error}
> >
> > 2)
...
> > 
> > ~~~
> > Error in st_as_sf(newplot_locations_HARV, coords = c("decimalLon", "decimalLat"), : object 'newplot_locations_HARV' not found
> > ~~~
> > {: .error}
> >
