...
~~~
Error: Cannot open "data/NEON-DS-Site-Layout-Files/HARV/HARVtower_UTM18N.shp"; The file doesn't seem to exist.
~~~
{: .error}
...
~~~
Error: Cannot open "data/NEON-DS-Site-Layout-Files/HARV/HARV_roads.shp"; The file doesn't seem to exist.
~~~
{: .error}
...
~~~
Error: Cannot open "data/NEON-DS-Site-Layout-Files/HARV/HarClip_UTMZ18.shp"; The file doesn't seem to exist.
~~~
{: .error}
...
~~~
Error in as.data.frame(CHM_HARV, xy = TRUE): object 'CHM_HARV' not found
~~~
{: .error}
...
~~~
Error in st_crs(point_HARV): object 'point_HARV' not found
~~~
{: .error}
...
~~~
Error in st_as_sf(plot_locations_HARV, coords = c("easting", "northing"), : object 'plot_locations_HARV' not found
~~~
{: .error}
...
~~~
Error in st_as_sf(CHM_HARV_df, coords = c("x", "y"), crs = utm18nCRS): object 'CHM_HARV_df' not found
~~~
{: .error}
...
~~~
Error: Cannot open "data/NEON-DS-Site-Layout-Files/HARV/PlotLocations_HARV.shp"; The file doesn't seem to exist.
~~~
{: .error}


~~~
Error in st_union(CHM_rand_sample): object 'CHM_rand_sample' not found
~~~
{: .error}
...
~~~
Error in fortify(data): object 'CHM_HARV_df' not found
~~~
{: .error}
...
~~~
Error in crop(x = CHM_HARV, y = aoi_boundary_HARV): object 'CHM_HARV' not found
~~~
{: .error}
...
~~~
Error in as.data.frame(CHM_HARV_Cropped, xy = TRUE): object 'CHM_HARV_Cropped' not found
~~~
{: .error}
...
~~~
Error in st_bbox(CHM_HARV): object 'CHM_HARV' not found
~~~
{: .error}
...
~~~
Error in st_bbox(CHM_HARV_Cropped): object 'CHM_HARV_Cropped' not found
~~~
{: .error}
...
~~~
Error in st_bbox(aoi_boundary_HARV): object 'aoi_boundary_HARV' not found
~~~
{: .error}
...
~~~
Error in st_bbox(plot_locations_sp_HARV): object 'plot_locations_sp_HARV' not found
~~~
{: .error}
...
> > 
> > ~~~
> > Error in crop(x = CHM_HARV, y = plot_locations_sp_HARV): object 'CHM_HARV' not found
> > ~~~
> > {: .error}
> > 
> > 
...
> > 
> > ~~~
> > Error in as.data.frame(CHM_plots_HARVcrop, xy = TRUE): object 'CHM_plots_HARVcrop' not found
> > ~~~
> > {: .error}
> > 
> > 
...
~~~
Error in st_as_sf(CHM_plots_HARVcrop_df, coords = c("x", "y"), crs = utm18nCRS): object 'CHM_plots_HARVcrop_df' not found
~~~
{: .error}
...
~~~
Error in crop(x = CHM_HARV, y = new_extent): object 'CHM_HARV' not found
~~~
{: .error}
...
~~~
Error in as.data.frame(CHM_HARV_manual_cropped, xy = TRUE): object 'CHM_HARV_manual_cropped' not found
~~~
{: .error}
...
~~~
Error in extract(x = CHM_HARV, y = aoi_boundary_HARV, df = TRUE): object 'CHM_HARV' not found
~~~
{: .error}
...
~~~
Error in extract(x = CHM_HARV, y = aoi_boundary_HARV, fun = mean): object 'CHM_HARV' not found
~~~
{: .error}
...
> > 
> > ~~~
> > Error in extract(x = CHM_HARV, y = plot_locations_sp_HARV, buffer = 20, : object 'CHM_HARV' not found
> > ~~~
> > {: .error}
> > 
> > 
