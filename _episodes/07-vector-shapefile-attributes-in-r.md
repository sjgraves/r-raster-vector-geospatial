...
~~~
Error in ncol(lines_HARV): object 'lines_HARV' not found
~~~
{: .error}
...
~~~
Error in head(lines_HARV): object 'lines_HARV' not found
~~~
{: .error}
...
> > 
> > ~~~
> > Error in ncol(point_HARV): object 'point_HARV' not found
> > ~~~
> > {: .error}
> > 
> > 
...
> > 
> > ~~~
> > Error in ncol(aoi_boundary_HARV): object 'aoi_boundary_HARV' not found
> > ~~~
> > {: .error}
...
~~~
Error in nrow(footpath_HARV): object 'footpath_HARV' not found
~~~
{: .error}
...
> > 
> > ~~~
> > Error in nrow(boardwalk_HARV): object 'boardwalk_HARV' not found
> > ~~~
> > {: .error}
...
> > 
> > ~~~
> > Error in nrow(stoneWall_HARV): object 'stoneWall_HARV' not found
> > ~~~
> > {: .error}
