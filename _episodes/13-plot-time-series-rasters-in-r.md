...
~~~
Error in gsub("_HARV_ndvi_crop", "", raster_names): object 'raster_names' not found
~~~
{: .error}
...
~~~
Error in gsub("X", "Day ", raster_names): object 'raster_names' not found
~~~
{: .error}
...
~~~
Error in unique(NDVI_HARV_stack_df$variable): object 'NDVI_HARV_stack_df' not found
~~~
{: .error}
...
~~~
Warning in rm(raster_names, labels_names, green_colors): object 'raster_names'
not found
~~~
{: .error}
...
~~~
Warning in rm(raster_names, labels_names, green_colors): object 'labels_names'
not found
~~~
{: .error}
...
~~~
Error in eval(expr, envir, enclos): object 'raster_names' not found
~~~
{: .error}
...
> > 
> > ~~~
> > Error in gsub("Day", "Julian Day ", raster_names): object 'raster_names' not found
> > ~~~
> > {: .error}
> > 
> > 
