...
~~~
Reading layer `HarClip_UTMZ18' from data source `/home/travis/build/UW-Madison-DataScience/r-raster-vector-geospatial/_episodes_rmd/data/vector/HarClip_UTMZ18.shp' using driver `ESRI Shapefile'
...
We can get more information about the CRS with the 
st_crs() function, the CRS code number, and method to get information on the CRS in the proj4string.   



~~~
st_crs(32618)$proj4string
~~~
{: .language-r}
...
> > 
> > ~~~
> > Reading layer `HARV_roads' from data source `/home/travis/build/UW-Madison-DataScience/r-raster-vector-geospatial/_episodes_rmd/data/vector/HARV_roads.shp' using driver `ESRI Shapefile'
...
> > 
> > ~~~
> > Reading layer `HARVtower_UTM18N' from data source `/home/travis/build/UW-Madison-DataScience/r-raster-vector-geospatial/_episodes_rmd/data/vector/HARVtower_UTM18N.shp' using driver `ESRI Shapefile'
